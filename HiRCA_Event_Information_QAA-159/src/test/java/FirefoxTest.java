...
public class FirefoxTest {
	...
	public void deleteNewRecord(String recordName) throws Exception{
	  ...
	  public void openCheckRecord(String text184, String text, String paragraph, String get_date, String get_time, String get_dept, String creationDate) throws Exception{
	...
	public void SanityTest() throws Exception{
		...
		//Clicks on Analysis 
		  ...
		  openCheckRecord(text184,text,paragraph,get_date,get_time,get_dept,creationDate);
		  //Opens record
		  openReport();
		  //Downloads record
		  downloadRecord();
