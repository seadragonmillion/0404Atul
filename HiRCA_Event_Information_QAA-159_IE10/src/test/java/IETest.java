...
public class IETest {
	...
	public void deleteNewRecord(String recordName) throws Exception{
		  ...
		  if(name1.equals(recordName))
		  {
			  ...
			  if (name!=recordName)
				  System.out.println("Record deleted "+recordName);
			  else
	...
	@Test
	  public void SanityTest() throws Exception{
		  ...
		  if (login==1)
        {
		  ...
		  Thread.sleep(5000);
		  //Click on set time
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='ui-popup-container fade in ui-popup-active']/div/span/div[2]/div/a")));
		  ...
		  jse.executeScript("scroll(0,0)");
		  driver.findElement(By.id("efi-irca-button-new")).sendKeys(Keys.ARROW_UP);
		  driver.findElement(By.id("efi-irca-button-new")).sendKeys(Keys.ARROW_UP);
		  Thread.sleep(4000);
		  //Clicks on Save
		  wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("efi-irca-button-save"))).click();
