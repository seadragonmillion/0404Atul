	  ...
	  public void beforeTest() throws MalformedURLException{
		  ...
		  public void fillLOP() throws Exception {
			  ...
			  for (int i=1;i<=n;i++)
			  {
				  ...
				  try{
				  	wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/div["+y+"]/fieldset/div/div[2]/div/div/textarea")));
				  }catch(org.openqa.selenium.TimeoutException e)
				  {
				  	wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/div["+y+"]/fieldset/div/div[2]/div/h4/a"))).click();
				  }
			  ...
			  while(j<(n2*3))
			  {
				  ...
				  if(y==1)
				  {
					  ...
					  String lop23h=wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table[3]/tbody/tr["+j+"]/td[3]/fieldset/div/div["+y+"]/input"))).getAttribute("piivalue");
					  System.out.println(lop23h);
					  softly.assertThat(lop23h).as("test data").isEqualTo("H");
					  hml.add("High");
				  }
				  if(y==2)
				  {
					  ...
					  String lop23h=wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table[3]/tbody/tr["+j+"]/td[3]/fieldset/div/div["+y+"]/input"))).getAttribute("piivalue");
					  System.out.println(lop23h);
					  softly.assertThat(lop23h).as("test data").isEqualTo("M");
					  hml.add("Medium");
				  }
				  if(y==3)
				  {
					  ...
					  String lop23h=wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table[3]/tbody/tr["+j+"]/td[3]/fieldset/div/div["+y+"]/input"))).getAttribute("piivalue");
					  System.out.println(lop23h);
					  softly.assertThat(lop23h).as("test data").isEqualTo("L");
					  hml.add("Low");
				  }
				  if(y==0)
					  hml.add("None");
