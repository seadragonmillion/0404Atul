	...
	@Test
	  public void SanityTest() throws Exception{
		...
		//Checking if footer image appears
		  ...
		  String actual_copyright = driver.findElement(By.xpath(".//*[@id='pii-slides-equip-F192']/li/span/span")).getAttribute("textContent");
		  ...
		  for (int i=2;i<=n;i++)
		  {
			...
			//Checking if title is correct
			  ...
			  Thread.sleep(4000);
			  //Checking if copyright is correct
			  String copyright_xpath = ".//*[@id='pii-slides-equip-F192']/li["+i+"]/span/span";
