	...
	@Test
	  public void SanityTest() throws Exception{
		...
		Login();
		  ...
		  String actual_title = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F718']/ul/li/div")).getText();
		  String expected_title = "F718: What is the difference between a failure mechanism and a failure mode?";
		  assertEquals (actual_title, expected_title);
		  //Checking if footer image appears
		  if(driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F718']/ul/li/span/img")).isDisplayed())
			  System.out.println("Logo is displayed");
		  Thread.sleep(2000);
		  //Checking if copyright is correct
		  String actual_copyright = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F718']/ul/li/span/span")).getAttribute("textContent");
		  ...
		  Thread.sleep(1000);
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-slideshow-equip-F718']/ul/li/div"))).click();
		  Thread.sleep(3000);
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-equip-show-F718"))).click();
		  //Click on next
		  ...
		  for (int i=2;i<=n;i++)
		  {
			...
			//Checking if title is correct
			  ...
			  String title_xpath = ".//*[@id='pii-slideshow-equip-F718']/ul/li["+i+"]/div";
