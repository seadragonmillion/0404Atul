	...
	public void Login() throws Exception{
	  ...
	  public void openReport() throws Exception{
	    ...
	    public void shareReport() throws Exception{
			...
			softly.assertThat(user).as("test data").isEqualTo("QAA Creator (qaacreator)");
			//Clicks on save
	  ...
	  public void SanityTest() throws Exception{
		  ...
		  driver.findElement(By.id("pii-ircam-tab-1-title")).sendKeys(EventTitleIE);
		  ...
		  if ((ev1.equals(EventTitleIE)==false))
		  {
