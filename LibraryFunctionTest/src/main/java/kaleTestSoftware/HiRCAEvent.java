...
public class HiRCAEvent {
	...
	public void saveFourthReportCheckImages(WebDriver driver, String username, String password, Login obj, int f, String recordName, String reportTitle) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(obj2.HiRCAPopupMessage)).click();
	...
	public void saveNewReport(WebDriver driver, String username, String password, Login obj,int f, String recordName, String reportTitle) throws Exception{
		...
		obj2.verifySavePopup(driver, softly);
		//Clicks on Save report
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj2.HiRCAPopupMessage)).click();
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj2.HiRCAPopupConfirmButton)).click();
		//Verify save sticky
	...
	public void openReport(WebDriver driver, String recordName) throws Exception{
		...
		//Clicks on Save report
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj.HiRCAPopupMessage)).click();
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj.HiRCAPopupConfirmButton)).click();
	...
	public void openCheckRecord(WebDriver driver, String username,  String get_date, String get_time, String get_dept, String creationDate) throws Exception{
		...
		share.scrollToAPoint(driver, 3300);
		Thread.sleep(2000);
		int n =3500;
		...
		{				  
			...
			//share.scrollToElement(driver, wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id(id))));
			if(browserName.contains("safari"))
			{
				while(true)
				{
	...
	public void rootCause(WebDriver driver) throws Exception {
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj.HiRCAPopupMessage)).click();
		wait1.until(ExpectedConditions.visibilityOfElementLocated(obj.HiRCAPopupConfirmButton)).click();
		wait1.until(ExpectedConditions.invisibilityOfElementLocated(obj.HiRCAPopupMessage));
		//Click on Act of Nature
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/div[4]/fieldset/div/div/label"))).click();
		//Enter data in reason entry
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-reason-entry"))).sendKeys(reason1);
	...
	public void uploadFiveImagesSafari(WebDriver driver, String username, String reportTitle) throws Exception {
		...
		for (int j=0; j<5; j++)
		{
			...
			if(driver.findElement(By.id(img)).isDisplayed())
			{
				...
				Thread.sleep(1000);
				share.scrollToElement(driver, driver.findElement(By.id(del)));
				...
				share.scrollToElement(driver, driver.findElement(obj1.HiRCAPopupConfirmButton));
				while (true)
				{
					...
					try{
						wait.until(ExpectedConditions.invisibilityOfElementLocated(obj1.HiRCAPopupConfirmButton));
						break;
				...
				if(j!=0)
				{
					share.scrollToElement(driver, driver.findElement(By.id("pii-irca-addnewfile-button")));
				...
				Thread.sleep(2000);
				//Clicks on Save
				share.scrollToElement(driver, driver.findElement(By.id("efi-irca-button-save")));				
		...
		//Delete 3rd image
		share.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-event-file-remove-2"))));
		...
		share.scrollToElement(driver, wait.until(ExpectedConditions.elementToBeClickable(By.id("pii-irca-event-filecollapsible-4"))));
		while(true)
		{
		...
		//Clicks on Save report
		wait.until(ExpectedConditions.visibilityOfElementLocated(obj1.HiRCAPopupMessage));
		jse.executeScript("document.getElementById('pii-irca-dialog-confirmed').focus();");
	...
	public void uploadFiveImagesChrome(WebDriver driver, String username, String reportTitle) throws Exception {
		...
		for (int j=0; j<5; j++)
		{
			...
			if(driver.findElement(By.id(img)).isDisplayed())
			{
				...
				if(driver.findElement(By.id(img)).isDisplayed())
				{
					share.scrollToAPoint(driver, 2200);
					//Click on attach another file
					Thread.sleep(2000);
					WebElement add= driver.findElement(By.id("pii-irca-addnewfile-button"));
					add.click();
		...
		//Delete 3rd image
		share.scrollToAPoint(driver, 600);
	...
	public void uploadFiveImagesFirefox(WebDriver driver, String username, String reportTitle) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(obj1.HiRCAPopupConfirmButton)).click();
		//Click on last collapsible
		share.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-event-filecollapsible-4"))));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-event-filecollapsible-4"))).click();
		//Fill title and description
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-event-file-title-4"))).sendKeys("Title05");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-irca-event-file-description-4"))).sendKeys("Description05");
	...
	public void uploadFiveImagesIE10(WebDriver driver, String username, String reportTitle) throws Exception {
		...
		for (int j=0; j<5; j++)
		{
			...
			if(driver.findElement(By.id(img)).isDisplayed())
			{
				...
				if(driver.findElement(By.id(img)).isDisplayed())
				{
					share.scrollToAPoint(driver, 1800);
					//Click on attach another file
					Thread.sleep(2000);
		...
		for (int j=0; j<5; j++)
		{
			...
			if(driver.findElement(By.id(img)).isDisplayed())
			{
				...
				if(driver.findElement(By.id(img)).isDisplayed())
				{
					if(j<3)
					{ 
						share.scrollToAPoint(driver, 1600);
					} 
					if(j>2)
					{ 
						share.scrollToAPoint(driver, 2000);
