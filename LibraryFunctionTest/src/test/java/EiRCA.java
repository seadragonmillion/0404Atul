...
public class EiRCA {
	...
	public void enable44In2ndFailureMode(WebDriver driver) throws Exception {
		...
		obj.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.Step4FailureMode2Option47CheckBox)));
		//4.6
	...
	public void pdfCheck(WebDriver driver, HashMap<String,String>hm) throws Exception{
		...
		softly.assertThat(newData1).as("test data").contains(eirca2.textCreate(driver));
	...
	public void editEiRCAReport(WebDriver driver) throws Exception {
		...
		if(driver.findElement(eirca.Step3TableOption34CheckBox).isSelected() ==false)
			wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.Step3TableOption34CheckBox)).click();
		obj1.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.Step3TableOption35CheckBox)));
		...
		//Click on Step 5
		obj1.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(eirca.EiRCAStep5Tab)));
