...
public class EquipmentCaseLoad {
	...
	String keyword1ee = "Slide100imagesee";
	String keyword2ee = "Slide100NoImagesee";
	String keyword3ee = "Slide100Images50ee";
	String keyword1me = "Slide100Imagesme";
	String keyword2me = "Slide100NoImagesme";
	String keyword3me = "Slide100Images50me";
	String keyword1eqie = "Slide100imageseqie";
	String keyword2eqie = "Slide100NoImageseqie";
	String keyword3eqie = "Slide100Images50eqie";
	String keyword1eeie = "Slide100imageseeie";
	String keyword2eeie = "Slide100NoImageseeie";
	String keyword3eeie = "Slide100Images50eeie";
	String keyword1meie = "Slide100Imagesmeie";
	String keyword2meie = "Slide100NoImagesmeie";
	String keyword3meie = "Slide100Images50meie";
	...
	public String createCaseChrome (WebDriver driver, String title, String keyword, int r) throws Exception {
		...
		obj.scrollToElement(driver, wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-admin-efse-upload-file-input"))));
