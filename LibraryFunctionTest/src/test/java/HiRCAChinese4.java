...
public class HiRCAChinese4 {
	...
	public void chineseLevel3SelectionsStep4_1st(WebDriver driver, SoftAssertions softly) throws Exception {
		...
		String tr133 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[102]/td[1]/label"))).getText();
		System.out.println(tr133);
		softly.assertThat(tr133).as("test data").contains("纠正行动:");
		String tr134 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[102]/td[1]/label/small"))).getText();
		System.out.println(tr134);
		softly.assertThat(tr134).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr135 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[102]/td[1]/textarea"))).getText();
		System.out.println(tr135);
		softly.assertThat(tr135).as("test data").contains("改善纠正措施制度的监督与执行");
		String tr136 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[103]/td[1]"))).getText();
		System.out.println(tr136);
		softly.assertThat(tr136).as("test data").isEqualTo("3.9.1: 培训材料在适用性、及时性或实用性方面有所欠缺");
		String tr137 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[105]/td[1]/label"))).getText();
		System.out.println(tr137);
		softly.assertThat(tr137).as("test data").contains("纠正行动:");
		String tr138 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[105]/td[1]/label/small"))).getText();
		System.out.println(tr138);
		softly.assertThat(tr138).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr139 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[105]/td[1]/textarea"))).getText();
		System.out.println(tr139);
		softly.assertThat(tr139).as("test data").contains("加强培训资源, 开展作业任务分析，从而使培训材料、课程及时间与员工执行的任务相匹配");
		String tr140 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[106]/td[1]"))).getText();
		System.out.println(tr140);
		softly.assertThat(tr140).as("test data").isEqualTo("3.9.2: 复训频率不高(>> 一年)");
		String tr141 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[108]/td[1]/label"))).getText();
		System.out.println(tr141);
		softly.assertThat(tr141).as("test data").contains("纠正行动:");
		String tr142 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[108]/td[1]/label/small"))).getText();
		System.out.println(tr142);
		softly.assertThat(tr142).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr143 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[108]/td[1]/textarea"))).getText();
		System.out.println(tr143);
		softly.assertThat(tr143).as("test data").contains("增加复训频率，改善复训形式");
		String tr144 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[109]/td[1]"))).getText();
		System.out.println(tr144);
		softly.assertThat(tr144).as("test data").isEqualTo("3.9.3: 部门管理层未充分参与培训材料的编写和培训的实施");
		String tr145 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[111]/td[1]/label"))).getText();
		System.out.println(tr145);
		softly.assertThat(tr145).as("test data").contains("纠正行动:");
		String tr146 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[111]/td[1]/label/small"))).getText();
		System.out.println(tr146);
		softly.assertThat(tr146).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr147 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[111]/td[1]/textarea"))).getText();
		System.out.println(tr147);
		softly.assertThat(tr147).as("test data").contains("完善关于管理层参与培训材料编写或培训实施的相关要求");
		String tr148 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[112]/td[1]"))).getText();
		System.out.println(tr148);
		softly.assertThat(tr148).as("test data").isEqualTo("3.9.4: 未将经验教训充分包含到培训中");
		String tr149 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[114]/td[1]/label"))).getText();
		System.out.println(tr149);
		softly.assertThat(tr149).as("test data").contains("纠正行动:");
		String tr150 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[114]/td[1]/label/small"))).getText();
		System.out.println(tr150);
		softly.assertThat(tr150).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr151 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[114]/td[1]/textarea"))).getText();
		System.out.println(tr151);
		softly.assertThat(tr151).as("test data").contains("提高对培训效果的审查");
		String tr152 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[115]/td[1]"))).getText();
		System.out.println(tr152);
		softly.assertThat(tr152).as("test data").isEqualTo("3.9.5: 所需培训开展不充分（脱岗）");
		String tr153 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[117]/td[1]/label"))).getText();
		System.out.println(tr153);
		softly.assertThat(tr153).as("test data").contains("纠正行动:");
		String tr154 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[117]/td[1]/label/small"))).getText();
		System.out.println(tr154);
		softly.assertThat(tr154).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr155 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[117]/td[1]/textarea"))).getText();
		System.out.println(tr155);
		softly.assertThat(tr155).as("test data").contains("完善承包商控制方针, 完善培训资源");
		String tr156 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[118]/td[1]"))).getText();
		System.out.println(tr156);
		softly.assertThat(tr156).as("test data").isEqualTo("3.9.6: 所需培训开展不充分（在岗）");
		String tr157 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[120]/td[1]/label"))).getText();
		System.out.println(tr157);
		softly.assertThat(tr157).as("test data").contains("纠正行动:");
		String tr158 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[120]/td[1]/label/small"))).getText();
		System.out.println(tr158);
		softly.assertThat(tr158).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr159 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[120]/td[1]/textarea"))).getText();
		System.out.println(tr159);
		softly.assertThat(tr159).as("test data").contains("完善在岗培训方针, 完善培训资源");
		String tr160 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[121]/td[1]"))).getText();
		System.out.println(tr160);
		softly.assertThat(tr160).as("test data").isEqualTo("3.10.1: 关键岗位员工的作业授权不充分");
		String tr161 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[123]/td[1]/label"))).getText();
		System.out.println(tr161);
		softly.assertThat(tr161).as("test data").contains("纠正行动:");
		String tr162 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[123]/td[1]/label/small"))).getText();
		System.out.println(tr162);
		softly.assertThat(tr162).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr163 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[123]/td[1]/textarea"))).getText();
		System.out.println(tr163);
		softly.assertThat(tr163).as("test data").contains("完善作业授权");
		String tr164 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[124]/td[1]"))).getText();
		System.out.println(tr164);
		softly.assertThat(tr164).as("test data").isEqualTo("3.10.2: 关键岗位主管和（或）经理授权不充分");
		String tr165 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[126]/td[1]/label"))).getText();
		System.out.println(tr165);
		softly.assertThat(tr165).as("test data").contains("纠正行动:");
		String tr166 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[126]/td[1]/label/small"))).getText();
		System.out.println(tr166);
		softly.assertThat(tr166).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr167 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[126]/td[1]/textarea"))).getText();
		System.out.println(tr167);
		softly.assertThat(tr167).as("test data").contains("完善主管和经理的岗位授权");
		String tr168 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[127]/td[1]"))).getText();
		System.out.println(tr168);
		softly.assertThat(tr168).as("test data").isEqualTo("3.10.3: 供应商服务（QA/RC、来源检查）授权不充分");
		String tr169 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[129]/td[1]/label"))).getText();
		System.out.println(tr169);
		softly.assertThat(tr169).as("test data").contains("纠正行动:");
		String tr170 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[129]/td[1]/label/small"))).getText();
		System.out.println(tr170);
		softly.assertThat(tr170).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr171 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[129]/td[1]/textarea"))).getText();
		System.out.println(tr171);
		softly.assertThat(tr171).as("test data").contains("完善供应商控制制度");
		String tr172 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[130]/td[1]"))).getText();
		System.out.println(tr172);
		softly.assertThat(tr172).as("test data").isEqualTo("3.10.4: 现场供应商人员授权不充分");
		String tr173 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[132]/td[1]/label"))).getText();
		System.out.println(tr173);
		softly.assertThat(tr173).as("test data").contains("纠正行动:");
		String tr174 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[132]/td[1]/label/small"))).getText();
		System.out.println(tr174);
		softly.assertThat(tr174).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr175 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[132]/td[1]/textarea"))).getText();
		System.out.println(tr175);
		softly.assertThat(tr175).as("test data").contains("完善供应商控制制度");
		String tr176 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[133]/td[1]"))).getText();
		System.out.println(tr176);
		softly.assertThat(tr176).as("test data").isEqualTo("3.10.5: 培训教员授权不充分");
		String tr177 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[134]/td[1]/label"))).getText();
		...
		String tr200 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[153]/td[1]"))).getText();
	...
	public void chineseLevel3SelectionsStep4_4th(WebDriver driver, SoftAssertions softly) throws Exception {
		...
		String tr41 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[35]/td[1]/label"))).getText();
		softly.assertThat(tr41).as("test data").contains("纠正行动:");
		String tr42 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[35]/td[1]/label/small"))).getText();
		softly.assertThat(tr42).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr43 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[35]/td[1]/textarea"))).getText();
		softly.assertThat(tr43).as("test data").isEqualTo("增加偏出控制手段如拍照现场核实照片");
		String tr44 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[36]/td[1]"))).getText();
		softly.assertThat(tr44).as("test data").isEqualTo("3.13.1: 尽早完成工作，以便尽早回家");
		String tr45 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[38]/td[1]/label"))).getText();
		softly.assertThat(tr45).as("test data").contains("纠正行动:");
		String tr46 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[38]/td[1]/label/small"))).getText();
		softly.assertThat(tr46).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr47 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[38]/td[1]/textarea"))).getText();
		softly.assertThat(tr47).as("test data").isEqualTo("要求员工在办公室做其他相关工作，从而消除不当动机");
		String tr48 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[39]/td[1]"))).getText();
		softly.assertThat(tr48).as("test data").isEqualTo("3.13.2: 尽早完成工作，以便获得奖励或免受惩罚");
		String tr49 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[41]/td[1]/label"))).getText();
		softly.assertThat(tr49).as("test data").contains("纠正行动:");
		String tr50 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[41]/td[1]/label/small"))).getText();
		softly.assertThat(tr50).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr51 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[41]/td[1]/textarea"))).getText();
		softly.assertThat(tr51).as("test data").isEqualTo("消除不当动机, 采用质量和生产相平衡的奖励机制");
		String tr52 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[42]/td[1]"))).getText();
		softly.assertThat(tr52).as("test data").isEqualTo("3.13.3: 尽早完成工作，以便开始其他工作（尤其是根据完成的工作量计算价钱的承包商）");
		String tr53 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[44]/td[1]/label"))).getText();
		softly.assertThat(tr53).as("test data").contains("纠正行动:");
		String tr54 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[44]/td[1]/label/small"))).getText();
		softly.assertThat(tr54).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr55 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[44]/td[1]/textarea"))).getText();
		softly.assertThat(tr55).as("test data").isEqualTo("使用奖惩机制来杜绝赶时间的态度");
		String tr56 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[45]/td[1]"))).getText();
		softly.assertThat(tr56).as("test data").isEqualTo("3.13.4: 尽早完成工作，以便到更为舒适的环境中休息（尤其是在高温、有辐射或潮湿环境下工作）");
		String tr57 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[47]/td[1]/label"))).getText();
		softly.assertThat(tr57).as("test data").contains("纠正行动:");
		String tr58 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[47]/td[1]/label/small"))).getText();
		softly.assertThat(tr58).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr59 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[47]/td[1]/textarea"))).getText();
		softly.assertThat(tr59).as("test data").isEqualTo("给予充分的休息时间, 减少工作场所不舒适的工作条件");
		String tr60 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[48]/td[1]"))).getText();
		softly.assertThat(tr60).as("test data").isEqualTo("3.14.1: 观察主管向下属提供反馈的频率和质量");
		String tr61 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[50]/td[1]/label"))).getText();
		softly.assertThat(tr61).as("test data").contains("纠正行动:");
		String tr62 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[50]/td[1]/label/small"))).getText();
		softly.assertThat(tr62).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr63 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[50]/td[1]/textarea"))).getText();
		softly.assertThat(tr63).as("test data").isEqualTo("监督管理能力培训");
		String tr64 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[51]/td[1]"))).getText();
		softly.assertThat(tr64).as("test data").isEqualTo("3.14.2: 违反既定规定的情况不容易被知道（尤其是单独工作时）");
		String tr65 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[53]/td[1]/label"))).getText();
		softly.assertThat(tr65).as("test data").contains("纠正行动:");
		String tr66 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[53]/td[1]/label/small"))).getText();
		softly.assertThat(tr66).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr67 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[53]/td[1]/textarea"))).getText();
		softly.assertThat(tr67).as("test data").isEqualTo("提高工作绩效跟踪");
		String tr68 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[54]/td[1]"))).getText();
		softly.assertThat(tr68).as("test data").isEqualTo("3.14.3: 由于缺乏明确的问责制，认为违规的后果不严重");
		String tr69 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[56]/td[1]/label"))).getText();
		softly.assertThat(tr69).as("test data").contains("纠正行动:");
		String tr70 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[56]/td[1]/label/small"))).getText();
		softly.assertThat(tr70).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr71 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[56]/td[1]/textarea"))).getText();
		softly.assertThat(tr71).as("test data").isEqualTo("改善问责制");
		String tr72 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[57]/td[1]"))).getText();
		softly.assertThat(tr72).as("test data").isEqualTo("3.14.4: 违规造成的受伤风险被认为很低或没有");
		String tr73 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[59]/td[1]/label"))).getText();
		softly.assertThat(tr73).as("test data").contains("纠正行动:");
		String tr74 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[59]/td[1]/label/small"))).getText();
		softly.assertThat(tr74).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr75 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[59]/td[1]/textarea"))).getText();
		softly.assertThat(tr75).as("test data").isEqualTo("改善问责制");
		String tr76 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[60]/td[1]"))).getText();
		softly.assertThat(tr76).as("test data").isEqualTo("3.14.5: 由于有监护人在场，预期风险更低");
		String tr77 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[62]/td[1]/label"))).getText();
		softly.assertThat(tr77).as("test data").contains("纠正行动:");
		String tr78 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[62]/td[1]/label/small"))).getText();
		softly.assertThat(tr78).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr79 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[62]/td[1]/textarea"))).getText();
		softly.assertThat(tr79).as("test data").isEqualTo("提高监督, 改善现场观察, 改善问责制");
		String tr80 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[63]/td[1]"))).getText();
		softly.assertThat(tr80).as("test data").isEqualTo("3.15.1: 员工未经过相互指导的培训，或纠正他人违规情况的培训");
		String tr81 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[65]/td[1]/label"))).getText();
		softly.assertThat(tr81).as("test data").contains("纠正行动:");
		String tr82 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[65]/td[1]/label/small"))).getText();
		softly.assertThat(tr82).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr83 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[65]/td[1]/textarea"))).getText();
		softly.assertThat(tr83).as("test data").isEqualTo("同事互助提醒（好文化）培训");
		String tr84 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[66]/td[1]"))).getText();
		softly.assertThat(tr84).as("test data").isEqualTo("3.15.2: 未要求员工对纠正他人违规的情况承担责任");
		String tr85 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[68]/td[1]/label"))).getText();
		softly.assertThat(tr85).as("test data").contains("纠正行动:");
		String tr86 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[68]/td[1]/label/small"))).getText();
		softly.assertThat(tr86).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr87 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[68]/td[1]/textarea"))).getText();
		softly.assertThat(tr87).as("test data").isEqualTo("建立关于同事互助提醒（好文化）的管理期望");
		String tr88 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[69]/td[1]"))).getText();
		softly.assertThat(tr88).as("test data").isEqualTo("3.15.3: 员工未充分理解相关行为规范");
		String tr89 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[71]/td[1]/label"))).getText();
		softly.assertThat(tr89).as("test data").contains("纠正行动:");
		String tr90 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[71]/td[1]/label/small"))).getText();
		softly.assertThat(tr90).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr91 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[71]/td[1]/textarea"))).getText();
		softly.assertThat(tr91).as("test data").isEqualTo("行为规范培训, 采用行为规范提醒物, 采用禁止事项警告清单");
		String tr92 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[72]/td[1]"))).getText();
		softly.assertThat(tr92).as("test data").contains("3.15.4: 主管未到现场强化");
		softly.assertThat(tr92).as("test data").contains("同事指导");
		String tr93 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[74]/td[1]/label"))).getText();
		softly.assertThat(tr93).as("test data").contains("纠正行动:");
		String tr94 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[74]/td[1]/label/small"))).getText();
		softly.assertThat(tr94).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr95 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[74]/td[1]/textarea"))).getText();
		softly.assertThat(tr95).as("test data").isEqualTo("监督管理能力培训, 就监督管理强化，对管理者实施问责");
		String tr96 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[75]/td[1]"))).getText();
		softly.assertThat(tr96).as("test data").isEqualTo("3.21.1: 未能识别和缓解时间相关的高风险情况，例如日常失误陷阱、工作时间、节假日影响等");
		String tr97 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[77]/td[1]/label"))).getText();
		softly.assertThat(tr97).as("test data").contains("纠正行动:");
		String tr98 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[77]/td[1]/label/small"))).getText();
		softly.assertThat(tr98).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr99 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[77]/td[1]/textarea"))).getText();
		softly.assertThat(tr99).as("test data").isEqualTo("高风险情境警觉培训");
		String tr100 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[78]/td[1]"))).getText();
		softly.assertThat(tr100).as("test data").isEqualTo("3.21.2: 未能识别和缓解活动相关的高风险情况，例如伪装的首次执行操作、利益失衡、单项弱点失去管理、专门技能缺陷等等");
		String tr101 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[80]/td[1]/label"))).getText();
		softly.assertThat(tr101).as("test data").contains("纠正行动:");
		String tr102 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[80]/td[1]/label/small"))).getText();
		softly.assertThat(tr102).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr103 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[80]/td[1]/textarea"))).getText();
		softly.assertThat(tr103).as("test data").isEqualTo("高风险情境警觉培训");
		String tr104 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[81]/td[1]"))).getText();
		softly.assertThat(tr104).as("test data").isEqualTo("3.21.3: 未能识别和缓解人员相关的高风险情况，例如能力、态度、性格、与人打交道的经验存在不足");
		String tr105 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[83]/td[1]/label"))).getText();
		softly.assertThat(tr105).as("test data").contains("纠正行动:");
		String tr106 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[83]/td[1]/label/small"))).getText();
		softly.assertThat(tr106).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr107 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[83]/td[1]/textarea"))).getText();
		softly.assertThat(tr107).as("test data").isEqualTo("高风险情境警觉培训");
		String tr108 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[84]/td[1]"))).getText();
		softly.assertThat(tr108).as("test data").isEqualTo("3.21.4: 未能识别和缓解环境相关的高风险情况，例如工作条件恶劣（温度、照明、噪音、高辐射水平等等）以及人机接口（标牌、显示屏、控制器等）");
		String tr109 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[86]/td[1]/label"))).getText();
		softly.assertThat(tr109).as("test data").contains("纠正行动:");
		String tr110 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[86]/td[1]/label/small"))).getText();
		softly.assertThat(tr110).as("test data").contains("通用纠正行动已预填。可直接修改为具体纠正行动。");
		String tr111 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='efi-irca-answers']/table/tbody/tr[86]/td[1]/textarea"))).getText();
