...
public class FirefoxTest {
	...
	private String keyword1 = "Slide100Imagesme";
	private String keyword2 = "Slide100NoImagesme";
	private String keyword3 = "Slide100Images50me";
	private int login;
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Load test 100 slides Mechanical performance search in Firefox");
	...
	public void test() throws Exception{
		...
		//Types in the keyword to get slide 8963
		...
		//Click on collapsible on F8963
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-collapsible-equip-F8963"))).click();
		//Waits for black loading message
		try{
			  wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("ui-icon-loading")));
			  wait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("ui-icon-loading")));
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-button-equip-F8963")));
		WebElement element =  driver.findElement(By.id("pii-slideshow-button-equip-F8963"));
		...
		driver.findElement(By.id("pii-slideshow-equip-F8963-popup"));
		...
		for(int i=0;i<n-1;i++)
		{
			...
			String load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F8963-"+(i+1)))).getAttribute("src");
			while (load.contains("loading.gif")==true)
			{
				load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F8963-"+(i+1)))).getAttribute("src");	
			}
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-slideshow-equip-F8963']/a"))).click();
		//Click on clear
		...
		//Types in the keyword to get slide 7453
		...
		//Click on collapsible on F7453
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-collapsible-equip-F7453"))).click();
		//Waits for black loading message
		try{
			  wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("ui-icon-loading")));
			  wait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("ui-icon-loading")));
		...
		//Clicks on Show Slides
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-button-equip-F7453")));
		element =  driver.findElement(By.id("pii-slideshow-button-equip-F7453"));
		slide = element.getText();
		System.out.println(slide);
		while (slide.equals("Show Slides(101)")==false)
		{
	    ...
	    element.sendKeys(Keys.TAB);
	    element.sendKeys(Keys.ENTER);
		driver.findElement(By.id("pii-slideshow-equip-F7453-popup"));
		System.out.println(number);
		...
		for(int i=0;i<n-1;i++)
		{
			...
			if(i==0)
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Next"))).click();
			String load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F7453-"+(i+1)))).getAttribute("src");
			while (load.contains("loading.gif")==true)
			{
				load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F7453-"+(i+1)))).getAttribute("src");	
			}
			long f2=System.currentTimeMillis();
			System.out.println("Total loading time in milliseconds: "+ (f2-f1));
			total=total+(f2-f1);
		...
		long total2=total;
		//Closes the slideshow
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-slideshow-equip-F7453']/a"))).click();
		//Click on clear
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-efse-clear"))).click();
		System.out.println("Case with 50 images and text");
		//Types in the keyword to get slide 7853
		...
		//Click on collapsible on F7853
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-collapsible-equip-F7853"))).click();
		//Waits for black loading message
		try{
			  wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("ui-icon-loading")));
			  wait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("ui-icon-loading")));
		...
		//Clicks on Show Slides
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-button-equip-F7853")));
		element =  driver.findElement(By.id("pii-slideshow-button-equip-F7853"));
		slide = element.getText();
		System.out.println(slide);
		while (slide.equals("Show Slides(101)")==false)
		{
	    ...
	    element.sendKeys(Keys.TAB);
	    element.sendKeys(Keys.ENTER);
		driver.findElement(By.id("pii-slideshow-equip-F7853-popup"));
		System.out.println(number);
		n = Integer.parseInt(number);
		Thread.sleep(1000);
		total=0;
		for(int i=0;i<n-1;i++)
		{
			...
			if(i==0)
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Next"))).click();
			String load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F7853-"+(i+1)))).getAttribute("src");
			while (load.contains("loading.gif")==true)
			{
				load=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideimg-F7853-"+(i+1)))).getAttribute("src");	
			}
			long f2=System.currentTimeMillis();
			System.out.println("Total loading time in milliseconds: "+ (f2-f1));
			total=total+(f2-f1);
		...
		//Closes the slideshow
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-slideshow-equip-F7853']/a"))).click();
		//Click on clear
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-efse-clear"))).click();
		//Logout
