...
public class CreateEFPDDCaseTest {
	...
	public void create_cases_for_in(String caseType, String devAsiaUSIE11) throws Exception {
		...
		{
			if(devAsiaUSIE11.contains("devAsia"))
				casePDD.addAll(obj.createCase(driver, obj.keywordPDD, obj.key1PDD, obj.key2PDD, obj.key3PDD, obj.titlePDD));
			if(devAsiaUSIE11.contains("devAsiaIE11"))
				casePDD.addAll(obj.createCase(driver, obj.keywordPDDie11, obj.key1PDDie11, obj.key2PDDie11, obj.key3PDDie11, obj.titlePDDie11));
			if(devAsiaUSIE11.contains("US"))
				casePDD.addAll(obj.createCase(driver, obj.keywordPDDUS, obj.key1PDDUS, obj.key2PDDUS, obj.key3PDDUS, obj.titlePDDUS));
			if(devAsiaUSIE11.contains("USIE11"))
				casePDD.addAll(obj.createCase(driver, obj.keywordPDDUSie11, obj.key1PDDUSie11, obj.key2PDDUSie11, obj.key3PDDUSie11, obj.titlePDDUSie11));
		...
		else
		{
			...
			if(devAsiaUSIE11.contains("devAsiaIE11"))
				caseEF.addAll(obj.createCase(driver, obj.keywordEFie11, obj.key1EFie11, obj.key2EFie11, obj.key3EFie11, obj.titleEFie11));
			if(devAsiaUSIE11.contains("US"))
				caseEF.addAll(obj.createCase(driver, obj.keywordEFUS, obj.key1EFUS, obj.key2EFUS, obj.key3EFUS, obj.titleEFUS));
			if(devAsiaUSIE11.contains("USIE11"))
				caseEF.addAll(obj.createCase(driver, obj.keywordEFUSie11, obj.key1EFUSie11, obj.key2EFUSie11, obj.key3EFUSie11, obj.titleEFUSie11));
	...
	public void search_for_case_in_equipment_performance_by_keyword_for_in(String caseType, String devAsiaUSIE11) throws Exception {
	...
	public void search_for_PDD_and_EF_case_in_failure_modes_in(String devAsiaUSIE11) throws Exception {
		...
		if(devAsiaUSIE11.contains("USIE11"))
			obj.searchCaseInFailureModes(driver, caseEF.get(0), casePDD.get(0), obj.keywordEFUSie11, obj.keywordPDDUSie11);	
	}
	...
	public void search_for_PDD_and_EF_case_in_each_other_in(String devAsiaUSIE11) throws Exception {
		...
		if(devAsiaUSIE11.contains("devAsiaIE11"))
			obj.searchCasesInPDDAndEFModules(driver, caseEF.get(0), casePDD.get(0), obj.keywordEFie11, obj.keywordPDDie11);
		if(devAsiaUSIE11.contains("US"))
			obj.searchCasesInPDDAndEFModules(driver, caseEF.get(0), casePDD.get(0), obj.keywordEFUS, obj.keywordPDDUS);
		if(devAsiaUSIE11.contains("USIE11"))
			obj.searchCasesInPDDAndEFModules(driver, caseEF.get(0), casePDD.get(0), obj.keywordEFUSie11, obj.keywordPDDUSie11);
	}
	...
	public void check_the_keyword_search_for_in_for_pii_indicator(String caseType, String devAsiaUSIE11, Integer piiNonpii) throws Exception {
		...
		{
			if(devAsiaUSIE11.contains("devAsia"))
				obj1.checkkeyword(driver, casePDD, obj.keywordPDD, obj.key1PDD, obj.key2PDD, obj.key3PDD, piiNonpii, obj.titlePDD);
			if(devAsiaUSIE11.contains("devAsiaIE11"))
				obj1.checkkeyword(driver, casePDD, obj.keywordPDDie11, obj.key1PDDie11, obj.key2PDDie11, obj.key3PDDie11, piiNonpii, obj.titlePDDie11);
			if(devAsiaUSIE11.contains("US"))
				obj1.checkkeyword(driver, casePDD, obj.keywordPDDUS, obj.key1PDDUS, obj.key2PDDUS, obj.key3PDDUS, piiNonpii, obj.titlePDDUS);
			if(devAsiaUSIE11.contains("USIE11"))
				obj1.checkkeyword(driver, casePDD, obj.keywordPDDUSie11, obj.key1PDDUSie11, obj.key2PDDUSie11, obj.key3PDDUSie11, piiNonpii, obj.titlePDDUSie11);
		}
		else
		{
			if(devAsiaUSIE11.contains("devAsia"))
				obj1.checkkeyword(driver, caseEF, obj.keywordEF, obj.key1EF, obj.key2EF, obj.key3EF, piiNonpii, obj.titleEF);
			if(devAsiaUSIE11.contains("devAsiaIE11"))
				obj1.checkkeyword(driver, caseEF, obj.keywordEFie11, obj.key1EF, obj.key2EF, obj.key3EF, piiNonpii, obj.titleEFie11);
			if(devAsiaUSIE11.contains("US"))
				obj1.checkkeyword(driver, caseEF, obj.keywordEFUS, obj.key1EF, obj.key2EF, obj.key3EF, piiNonpii, obj.titleEFUS);
			if(devAsiaUSIE11.contains("USIE11"))
				obj1.checkkeyword(driver, caseEF, obj.keywordEFUSie11, obj.key1EF, obj.key2EF, obj.key3EF, piiNonpii, obj.titleEFUSie11);
		}		
		Thread.sleep(2000);
	}
