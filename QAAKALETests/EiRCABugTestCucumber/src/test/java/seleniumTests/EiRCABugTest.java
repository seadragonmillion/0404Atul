...
import kaleTestSoftware.EiRCAPath2;
...
public class EiRCABugTest {
	...
	public void she_creates_an_EiRCA_report_to_test_all_bugs_in_new_version() throws Exception {
	    // eirca report
		EiRCAPath2 eirca = new EiRCAPath2();
		eirca.verifyEiRCAPath2(driver);
	}
