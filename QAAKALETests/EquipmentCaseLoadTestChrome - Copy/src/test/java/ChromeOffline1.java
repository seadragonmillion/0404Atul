  ...
  //          driver.quit();
	...
	@Before
	  public void beforeTest() throws MalformedURLException, InterruptedException{
		  ...
		  System.out.println("RV OfflineSync Testin");
...
//				assertEquals(driver.findElement(By.xpath("//a[contains(text(),'" + title + "')]")).isDisplayed(), true);
				...
				try{
					//Closes server warning
					String s1=wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("sticky-note"))).getText().trim();
					System.out.println("wifi back online sticky: "+s1);
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("sticky-close"))).click();
				}catch (org.openqa.selenium.TimeoutException e)
				{
