...
///////////////////////////////////////////////////////////////////////////////////////////////////////////				
				...
				Thread.sleep(1000);
				String m2= wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-rv-tab-1-title"))).getText();
				softly.assertThat(m2).as("test data").contains("//a[contains(text(),'" + title + "')]");	
				System.out.println("offline report title display as: "+m2);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("sticky-close"))).click();
							...
							{
								jse.executeScript("arguments[0].click();",wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("sticky-close"))));
							}*/
				Thread.sleep(5000);
				//Wait for loading message to disappear
				share2.loadingServer(driver);
