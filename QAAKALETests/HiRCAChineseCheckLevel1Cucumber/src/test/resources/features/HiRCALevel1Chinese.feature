Feature: Automated HiRCA level 1 Chinese

@ChromeTest
Scenario: Verify HiRCA level 1 chinese translations
	...
	And she verifies chinese translation for HiRCA report answering Level one questions
	And delete report
