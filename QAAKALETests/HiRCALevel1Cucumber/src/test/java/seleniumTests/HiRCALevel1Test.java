...
public class HiRCALevel1Test {
	...
	@When("she creates HiRCA report answering Level one questions with username as {string}")
	public void she_creates_HiRCA_report_answering_Level_one_questions_with_username_as(String username) throws Exception {
		HiRCALevel1 hl1 = new HiRCALevel1();
		hl1.HiRCAPathCheck(driver, username);
	}
