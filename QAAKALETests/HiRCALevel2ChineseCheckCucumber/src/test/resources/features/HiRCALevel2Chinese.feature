Feature: Automated HiRCA level 2 Chinese

@ChromeTest
Scenario: Verify HiRCA level 2 chinese translations
	...
	And she verifies chinese translation for HiRCA report answering Level two and Level three questions
