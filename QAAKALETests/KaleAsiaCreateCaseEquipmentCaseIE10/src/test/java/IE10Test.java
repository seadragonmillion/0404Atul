...
public class IE10Test {
	...
	@Test
		...
		if (login==1)
      {
		...
		List<String> eqCases = obj1.createCaseIE10(driver, obj1.keyword_same_eq, obj1.key1_eq, obj1.key2_eq, obj1.key3_eq, obj1.eq_title);
		System.out.println("Slides created for equipment: "+ eqCases);
		Thread.sleep(2000);
		//Creates 5 slides for Electrical Case Search
		List<String> eeCases = obj1.createCaseIE10(driver, obj1.keyword_same_ee, obj1.key1_ee, obj1.key2_ee, obj1.key3_ee, obj1.ee_title);
		System.out.println("Slides created for electrical "+eeCases);
		Thread.sleep(2000);
		//Creates 5 slides for Mechanical Case Search
		List<String> meCases = obj1.createCaseIE10(driver, obj1.keyword_same_me, obj1.key1_me, obj1.key2_me, obj1.key3_me, obj1.me_title);
