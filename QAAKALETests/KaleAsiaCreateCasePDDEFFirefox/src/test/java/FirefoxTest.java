...
public class FirefoxTest {
	...
	public void test() throws Exception {
	    ...
	    List<String> casePDD = obj2.createCaseFirefox(driver, obj2.keywordPDD, obj2.key1PDD, obj2.key2PDD, obj2.key3PDD, obj2.titlePDD);
	    System.out.println("Cases for Design "+casePDD);
	    //Create one case for Engineering Fundamentals
	    List<String> caseEF = obj2.createCaseFirefox(driver, obj2.keywordEF, obj2.key1EF, obj2.key2EF, obj2.key3EF, obj2.titleEF);
