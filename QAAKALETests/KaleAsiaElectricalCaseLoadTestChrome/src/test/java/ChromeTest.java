...
public class ChromeTest {
	...
	private String username ="jenkins_1";
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Load test 100 slides Electrical Failure mode search in Chrome");
	...
	public void test() throws Exception{
		...
		obj1.deletePreviousCase(driver, obj1.keyword1ee);
		...
		//Deletes any previous cases if any
		obj1.deletePreviousCase(driver, obj1.keyword2ee);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
		//Deletes any previous cases if any
		obj1.deletePreviousCase(driver, obj1.keyword3ee);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
		//Create case r=1 for no images, r=2 for 100 images, r=3 for 50 images
		//No Images
		String case1=obj1.createCaseChrome (driver, obj1.title2, obj1.keyword2ee, 1);
		//100 Images
		String case2=obj1.createCaseChrome (driver, obj1.title1, obj1.keyword1ee, 2);
		//50 Images
		String case3=obj1.createCaseChrome (driver, obj1.title3, obj1.keyword3ee, 3);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
		...
		long total1 = obj1.searchCase100(driver, obj1.keyword1ee, case2);
		//Case Q9928		
		System.out.println("Case with no images");
		long total2 = obj1.searchCase100(driver, obj1.keyword2ee, case1);
		//Case Q9638
		System.out.println("Case with 50 images and text");
		long total3 = obj1.searchCase100(driver, obj1.keyword3ee, case3);
		...
		obj1.storeData(driver,total1,total2,total3,obj1.sheetElecAsia);
		//Deletes all cases
