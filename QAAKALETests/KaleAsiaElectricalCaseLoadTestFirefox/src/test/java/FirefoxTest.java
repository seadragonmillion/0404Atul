...
public class FirefoxTest {
	...
	public void test() throws Exception{
		...
		//No Images
		String case1=obj1.createCaseFirefox (driver, obj1.title2, obj1.keyword2ee, 1);
		//100 Images
		String case2=obj1.createCaseFirefox (driver, obj1.title1, obj1.keyword1ee, 2);
		//50 Images
		String case3=obj1.createCaseFirefox (driver, obj1.title3, obj1.keyword3ee, 3);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
