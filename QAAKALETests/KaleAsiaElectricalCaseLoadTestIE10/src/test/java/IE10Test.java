...
public class IE10Test {
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Load test 100 slides Electrical Failure mode search in IE");
	...
	public void test() throws Exception{
		...
		//No Images
		String case1=obj1.createCaseIE (driver, obj1.title2, obj1.keyword2ee, 1);
		//100 Images
		String case2=obj1.createCaseIE (driver, obj1.title1, obj1.keyword1ee, 2);
		//50 Images
		String case3=obj1.createCaseIE (driver, obj1.title3, obj1.keyword3ee, 3);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
