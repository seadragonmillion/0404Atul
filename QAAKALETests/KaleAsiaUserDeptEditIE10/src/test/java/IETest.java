...
public class IETest {
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Verify department edit in IE");
	...
	public void test() throws Exception {
		...
		try{
		 ...
		 //Create user
		 obj1.createUser (driver, company_id, password,obj1.emailAsia);
		 //Create user with CM rights
		 obj1.createUserCM (driver, company_id, password,obj1.emailAsia);
		 //Logout as admin
		 obj.logout(driver);
		 //Activate user
		 obj1.activateUser(obj1.emailAsia,company_id,driver);
		 //Activate user with CM rights
		 obj1.activateUser(obj1.emailAsia,company_id+"testcm",driver);
