...
public class ChromeTest {
	...
	@Test
	  public void SanityTest() throws Exception{
		...
		List<String> eqCases = obj1.createCaseChrome(driver, obj3.keyword_same_eqUS, obj3.key1_eqUS, obj3.key2_eqUS, obj3.key3_eqUS, obj3.eq_titleUS);
		System.out.println("Slides created for equipment: "+ eqCases);
		Thread.sleep(2000);
		//Creates 5 slides for Electrical Case Search
		List<String> eeCases = obj1.createCaseChrome(driver, obj3.keywordUS_same_ee, obj3.key1_eeUS, obj3.key2_eeUS, obj3.key3_eeUS, obj3.ee_titleUS);
