...
public class FirefoxTest {
	...
	public void test() throws Exception {
	    ...
	    List<String> casePDD = obj2.createCaseFirefox(driver, obj2.keywordPDDUS, obj2.key1PDDUS, obj2.key2PDDUS, obj2.key3PDDUS, obj2.titlePDDUS);
	    System.out.println("Cases for Design "+casePDD);
	    //Create one case for Engineering Fundamentals
	    List<String> caseEF = obj2.createCaseFirefox(driver, obj2.keywordEFUS, obj2.key1EFUS, obj2.key2EFUS, obj2.key3EFUS, obj2.titleEFUS);
