...
public class ChromeTest {
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Load test 100 slides Human performance search in Chrome");
	...
	public void test() throws Exception{
		Login obj = new Login ();
		HumanCaseLoad obj1 = new HumanCaseLoad ();
		...
		obj1.deletePreviousCase(driver, obj1.keyword1);
		...
		//No Images
		String case1=obj1.createCaseChrome (driver, obj1.title2, obj1.keyword2, 1);
		//100 Images
		String case2=obj1.createCaseChrome (driver, obj1.title1, obj1.keyword1, 2);
		//50 Images
		String case3=obj1.createCaseChrome (driver, obj1.title3, obj1.keyword3, 3);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
		...
		long total1 = obj1.searchCase100(driver, obj1.keyword1, "Q"+case2);
		//Case Q9928		
		System.out.println("Case with no images");
		long total2 = obj1.searchCase100(driver, obj1.keyword2, "Q"+case1);
		//Case Q9638
		System.out.println("Case with 50 images and text");
		long total3 = obj1.searchCase100(driver, obj1.keyword3, "Q"+case3);
