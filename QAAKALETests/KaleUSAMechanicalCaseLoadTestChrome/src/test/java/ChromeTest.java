...
public class ChromeTest {
	...
	@Before
	  public void beforeTest() throws MalformedURLException{
		  ...
		  System.out.println("Load test 100 slides Mechanical Failure mode search in Chrome");
	...
	public void test() throws Exception{
		...
		//No Images
		String case1=obj1.createCaseChrome (driver, obj1.title2, obj1.keyword2me, 1);
		//100 Images
		String case2=obj1.createCaseChrome (driver, obj1.title1, obj1.keyword1me, 2);
		//50 Images
		String case3=obj1.createCaseChrome (driver, obj1.title3, obj1.keyword3me, 3);
		//Goes to KALE home page
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("pii-logo-div-element-kale"))).click();
