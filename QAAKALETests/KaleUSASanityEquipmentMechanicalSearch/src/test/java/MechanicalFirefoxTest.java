...
public class MechanicalFirefoxTest {
	...
	@Test
	  public void SanityTest() throws Exception{
		  ...
		  Thread.sleep(1000);
		  //Term search
		  obj1.browseTermEquip(driver, obj1.keywordMechProd, obj1.caseMechProd, obj1.titleMechProd);
		  //Case id search
		  obj1.browseCaseIDEquip(driver, obj1.caseMechProd, obj1.titleMechProd);
		  //Logs out
		  obj.logout(driver);
		  Thread.sleep(2000);
		  afterTest(obj1);			  	
