...
public class ChromeTest {
	...
	@Test
	  public void SanityTest() throws Exception{
		...
		List<String> eqCases = obj1.createCaseChrome(driver, obj3.keyword_same_eq, obj3.key1_eq, obj3.key2_eq, obj3.key3_eq, obj3.eq_title);
		System.out.println("Slides created for equipment: "+ eqCases);
		Thread.sleep(2000);
		//Creates 5 slides for Electrical Case Search
		List<String> eeCases = obj1.createCaseChrome(driver, obj3.keyword_same_ee, obj3.key1_ee, obj3.key2_ee, obj3.key3_ee, obj3.ee_title);
