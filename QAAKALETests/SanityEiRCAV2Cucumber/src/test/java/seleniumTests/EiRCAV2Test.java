...
///
	...
	@When("^she creates an EiRCA report to test all steps in version two with username as \"([^\"]*)\" and password as \"([^\"]*)\" and admin nonadmin environment indicator equals (\\d+)$")
	public void she_creates_an_EiRCA_report_to_test_all_steps_in_version_two_with_username_as_and_password_as_and_admin_nonadmin_environment_indicator_equals(String username, String password, int y) throws Exception {
	    // eirca report
		EiRCAV2 eirca = new EiRCAV2();
		eirca.reportCreate(driver, username,password,y);
	}
