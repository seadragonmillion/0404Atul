...
public class OPiRCA_Sanity {
	...
	@When("she creates an OPiRCA report with username as {string}")
	 ...
	 * 7=non admin ie11
	 */
	@When("share OPiRCA report with username as {string} and password as {string} and admin nonadmin environment indicator equals {int}")
	...
	@When("mark critical OPiRCA report with username as {string} and password as {string} and admin nonadmin environment indicator equals {int}")
	...
	@When("delete OPiRCA report with admin nonadmin environment indicator equals {int}")
