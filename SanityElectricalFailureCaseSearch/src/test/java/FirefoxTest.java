...
public class FirefoxTest {
	...
	public void SanityTest() throws Exception{
		...
		Login();
		  ...
		  driver.findElement(By.id("pii-efse-searchbyid-input")).sendKeys("1678");
		  Thread.sleep(1000);
		  ...
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-button-equip-F1678")));
		  Thread.sleep(2000);
		  element =  driver.findElement(By.id("pii-slideshow-button-equip-F1678"));
		  ...
		  Thread.sleep(1500);
		  //Checking if slide number appears and is correct
		  String actual_slide1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1678']/ul/li/span/span[2]")).getAttribute("textContent");
		  String expected_slide1 = "1/"+n;
		  assertEquals (actual_slide1, expected_slide1);
		  Thread.sleep(1000);
		  //Checking if title is correct
		  String actual_title1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1678']/ul/li/div")).getText();
		  ...
		  if(driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1678']/ul/li/span/img")).isDisplayed())
			  System.out.println("Logo is displayed");
		  //Checking if copyright is correct
		  String actual_copyright1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1678']/ul/li/span/span")).getAttribute("textContent");
		  ...
		  for (int j=2;j<=n;j++)
		  {
			  String id = "pii-slideimg-F1678-"+(j-1);
			  Thread.sleep(1000);
			  if(driver.findElement(By.id(id)).isDisplayed())
			  ...
			  if(driver.findElement(By.xpath(image_xpath)).isDisplayed())
				  System.out.println("Logo is displayed");
			  //Checking if slide number appears and is correct
			  String slide_xpath = ".//*[@id='pii-slideshow-equip-F1678']/ul/li["+j+"]/span/span[2]";
