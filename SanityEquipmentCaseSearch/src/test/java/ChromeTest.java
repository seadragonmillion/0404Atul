	...
	@Test
	  public void SanityTest() throws Exception{
		...
		//Checking if title is correct
		  String actual_title = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/div")).getText();
		  ...
		  String actual_copyright = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/span/span")).getText();
		  ...
		  String actual_slide = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/span/span[2]")).getText();
		...
		//Checks if clear feature works on case id field
		  ...
		  Thread.sleep(500);
		//Checking if slide number appears and is correct
		  String actual_slide1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/span/span[2]")).getText();
		  String expected_slide1 = "1/"+n;
		  assertEquals (actual_slide1, expected_slide1);
		  Thread.sleep(1000);
		  //Checking if title is correct
		  String actual_title1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/div")).getText();
		  String expected_title1 = "F1459: Sanity Test: DO NOT DELETE: QAA";
		  assertEquals (actual_title1, expected_title1);
		  //Checking if footer image appears
		  if(driver.findElement(By.xpath(".//*[@id='centered-btns2_s0']/span/img")).isDisplayed())
			  System.out.println("Logo is displayed");
		  //Checking if copyright is correct
		  String actual_copyright1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-button-equip-F1459']/ul/li/span/span")).getText();
