	...
	@Test
	  public void SanityTest() throws Exception{
		...
		//Checking if title is correct
		  ...
		  Thread.sleep(2000);
		  String actual_slide = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span[2]")).getAttribute("textContent");
		  String expected_slide = "1/"+n;
		  assertEquals (expected_slide,actual_slide);
		  //Checking if copyright is correct
		  Thread.sleep(2000);
		  String actual_copyright = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span")).getAttribute("textContent");
		...
		//Checks if clear feature works on case id field
		  ...
		  Thread.sleep(500);
		  //Checking if slide number appears and is correct
		  String actual_slide1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span[2]")).getAttribute("textContent");
		  String expected_slide1 = "1/"+n;
		  assertEquals (actual_slide1, expected_slide1);
		  Thread.sleep(1000);
		  //Checking if title is correct
		  String actual_title1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/div")).getText();
		  ...
		  if(driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/img")).isDisplayed())
			  System.out.println("Logo is displayed");
		  //Checking if copyright is correct
		  String actual_copyright1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span")).getAttribute("textContent");
