	...
	@Test
	  public void SanityTest() throws Exception{
		...
		//Checks if clear feature works on case id field
		  ...
		  Thread.sleep(500);
		//Checking if slide number appears and is correct
		  String actual_slide1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span[2]")).getText();
		  ...
		  if(driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/img")).isDisplayed())
			  System.out.println("Logo is displayed");
		  //Checking if copyright is correct
		  String actual_copyright1 = driver.findElement(By.xpath(".//*[@id='pii-slideshow-equip-F1459']/ul/li/span/span")).getText();
