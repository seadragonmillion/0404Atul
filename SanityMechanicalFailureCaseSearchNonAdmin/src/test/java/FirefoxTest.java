	...
	@Test
	  public void SanityTest() throws Exception{
		...
		//Checking if title is correct
		  ...
		  Thread.sleep(1000);
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='pii-slideshow-equip-F1210']/ul/li/div"))).click();
		  Thread.sleep(3000);
		  wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pii-slideshow-equip-show-F1210"))).click();
		  //Click on next
